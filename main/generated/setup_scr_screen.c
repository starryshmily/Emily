...
void setup_scr_screen(lv_ui *ui)
{
    ...
    //Write codes screen_img_1 (Commented out to show white background)
    //ui->screen_img_1 = lv_img_create(ui->screen);
    //lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    //lv_img_set_src(ui->screen_img_1, &_444_alpha_240x320);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 125, 47);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 13, 165);
    lv_obj_set_size(ui->screen_btn_2, 100, 50);

    //Write style for screen_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_2, 125, LV_PART_MAIN|LV_STATE_DEFAULT);
